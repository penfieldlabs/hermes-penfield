...
See ADR-0003 for why these paths differ from the original v1.0 spec.
"""
...
#   prod -> bare hosts, dev -> *-dev hosts. See ADR-0004.
PROD_HOSTS = {
...
ENDPOINTS: dict[str, tuple[str, str]] = {
    ...
    "memory_update": ("PUT", "/memories/{memory_id}"),  # NOT PATCH — see ADR-0003
